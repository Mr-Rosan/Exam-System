        ...
        <div class="layui-form layuimini-form">
            ...
            <div class="layui-form-item">
                ...
                <div class="layui-input-block">
                    <input type="email" name="email" lay-verify="email" placeholder="请输入邮箱" value="${student.email}" class="layui-input">
                </div>
            </div>
            <div class="layui-form-item">
                <label class="layui-form-label">用户名</label>
                <div class="layui-input-block">
                    <input type="text" name="username" placeholder="用户名" lay-verify="username" required value="${student.username}" class="layui-input">
                </div>
            </div>
...
<script>
    layui.use(['form','miniTab'], function () {
        ...
        form.on('submit(saveBtn)', function (data) {
            ...
            $.ajax({
                type: "POST",
                url: "${pageContext.request.contextPath}/student/studentInfo_do",
                data: {
                    id: data.field.id,
                ...
                success: function(data){
                    ...
                    if(data.code === 0) {
                        layer.msg(data.message, {icon: 1}, function(){
                            top.location.href = "${pageContext.request.contextPath}/student";
                        });
                    } else if (data.code === 1) {
